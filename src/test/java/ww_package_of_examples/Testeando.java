package ww_package_of_examples;

/*
 * Copyright 2015-2020 Austin Keener, Michael Ritter, Florian Spie�, and the JDA contributors
 *
...
public class Testeando extends ListenerAdapter
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            JDA jda = JDABuilder.createDefault("ODE3ODIxMTUwODU1ODIzNDEy.YEPFTA.8ro0KnoOTUQ7y3IJqNfNl2Oank0") // The token of the account that is logging in.
                    .addEventListeners(new Testeando())   // An instance of a class that will handle events.
                    .build();
